...
class Meeting(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True,blank=True)  # the time meeting was created
    updated = models.DateTimeField(auto_now=True,blank=True)  # time meeting was updated
    #duration = models.PositiveIntegerField(blank=True)
    #starting_date_time = models.DateTimeField(blank=True)
    #ending_date_time = models.DateTimeField(blank=True)
